...
class Const(object):
    ...
    def __init__(self): 
        self.CSatMP = 4.1e-8#1.16E-08            # CSat_MP: Initial value for solubility of dissolved iron at metal-passivation layer interface    g/cm^3
        self.CSatPO = 4.1e-8#1.16E-07            # CSat_ PO: solubility of dissolved iron at passivation-oxide layer interface    g/cm^3
        self.kd0 = .187#2.00E-01               # kd: Dissolution Rate Constant of Magnetite    cm/s
        self.km0 = 1.39#2.0E-01               # km:  Static Mass Transfer Coefficient    cm/s 
        self.f0 = 1.732050808             # f: Surface Area Factor (F* in thesis)    no unit
        self.S0 = 1.1                # S: supersaturation factor of small crystallites  no unit  
        self.CB0 = 1.49e-9#4.640E-8                 # CB: concentration of iron in bulk solution    g/cm^3
        ...
        self.DFe0 = 4.1e-4#0.0002735             # DFe: diffusivity of iron in water    cm^2/s
        ...
        self.CPO0 = 1.16e-9#1.16E-07              # CPO: concentration at passivating-oxide interface    g/cm^3     
        ...
        self.DP0 = 4.1e-4#0.000273486            # DP: diffusivity of iron in passivating layer    cm^2/s
        self.CSatOB = 1.2e-7#1.16E-7            # CSat_OB: Solubility of dissolved iron at oxide-bulk solution interface    g/cm^3    
        self.CeOB = 3.12e-8#6.96e-8#1.0E-10              # Ce_OB: Concentration of dissolved iron at Oxide-Bulk interface    g/cm^3
        ...
        self.U0 = 1619#2.5e2#188.9965                # U: Linear Velocity of Coolant    cm/s   
        ...
        self.RhoH2O0 = .691#0.92579            # RhoH2O: Density of Water    g/cm^3  
        self.ksp0 = 8000                # Ksp: Spalling time constant   
        self.Cell0 = 200.0                # Cell: Number of nodes
        self.Temperature0 = 310.0#140.0           # Temperature: Temperature    C    
